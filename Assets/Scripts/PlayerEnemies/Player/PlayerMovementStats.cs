...
public class PlayerMovementStats : ScriptableObject
{
    ...
    [Range(0.25f, 50f)] public float AirAceleration = 5f;
    ...
    [Range(1f, 1.1f)] public float JumpHeightCompensationFactor = 1.050f;
    ...
    [Header("Debug")]
    public bool DebugShowIsGrounderBox;
    ...
    [Range(0, 100)] public int ArcResolution = 20;
