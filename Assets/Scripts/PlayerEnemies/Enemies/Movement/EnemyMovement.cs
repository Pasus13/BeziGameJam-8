...
/// <summary>
/// Implementaci�n del sistema de movimiento para enemigos.
/// </summary>
public class EnemyMovement : MonoBehaviour, IEnemyMovement
{
    ...
    public void MoveTowards(Vector2 target, float speed)
    {
        ...
        // Calcular direcci�n horizontal (izquierda = -1, derecha = 1)
    ...
    public void Stop()
    {
        ...
        // Solo detener movimiento horizontal, mantener ca�da/salto
    ...
    public void PatrolBetweenPoints(Vector2 pointA, Vector2 pointB)
    {
        ...
        // Calcular direcci�n horizontal hacia el punto objetivo
        ...
        // Verificar si llegamos al punto objetivo (solo comprobaci�n en X)
